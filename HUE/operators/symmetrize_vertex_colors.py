...
class HUE_OT_symmetrize_vertex_colors(BaseColorOperator):
    """Mirror vertex colors across an axis"""

    bl_label = "Symmetrize Vertex Colors"
    bl_idname = "hue.symmetrize_vertex_colors"
    bl_options = {'REGISTER', 'UNDO'}

    def execute(self, context):
        scene = context.scene
        tool = scene.hue_symmetrize_tool
        mask = scene.hue_global_color_settings.get_mask()

...
class HUE_OT_add_color_by_position(BaseColorOperator):
    """Applies a gradient to vertex colors based on the selected source"""

    bl_label = "Apply Gradient"
    bl_idname = "hue.add_color_by_position"
    ...
    def _curvature_values(obj):
        ...
        return HUE_OT_add_color_by_position._normalize_np(raw)
    ...
    def _valence_values(obj):
        ...
        return HUE_OT_add_color_by_position._normalize_np(valence)
    ...
    def _face_area_values(obj):
        ...
        return HUE_OT_add_color_by_position._normalize_np(area_sum / area_count)
    ...
    def _edge_length_variance_values(obj):
        ...
        return HUE_OT_add_color_by_position._normalize_np(variance)
    ...
    def _face_quality_values(obj):
        ...
        return HUE_OT_add_color_by_position._normalize_np(quality_sum / quality_count)
...
class HUE_OT_reset_color_by_position_gradient(BaseOperator):
    """Resets the gradient to a default black and white value"""

    bl_label = "Reset Gradient"
    bl_idname = "hue.reset_color_by_position_gradient"
    bl_options = {'REGISTER', 'UNDO'}

    def execute(self, context):
        color_by_position_tool = context.scene.hue_color_by_position_tool

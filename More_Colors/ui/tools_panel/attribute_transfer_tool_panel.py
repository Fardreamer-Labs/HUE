...
class MC_PT_attribute_transfer_tool_panel(BasePanelInfo, Panel):
    bl_label = "Attribute Transfer"
    bl_idname = "MC_PT_attribute_transfer_tool_panel"
    ...
    def draw(self, context):
        ...
        layout.operator("morecolors.attribute_transfer", icon="BRUSH_DATA")

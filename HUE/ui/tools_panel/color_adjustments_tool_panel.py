...
class HUE_PT_color_adjustments_tool_panel(BasePanelInfo, Panel):
    bl_label = "Color Adjustments"
    bl_idname = "HUE_PT_color_adjustments_tool_panel"
    ...
    def draw(self, context):
        layout = self.layout
        tool = context.scene.hue_color_adjustments_tool
        ...
        layout.operator("hue.color_adjustments", icon="BRUSH_DATA")
